...
<html lang="en">
<head>
    <title>Mirielle's Invoice System || Manage Customer</title>
...
<body class="main-bg">
    ...
    <main class="container pt-5">
        <div class="d-flex flex-column justify-content-center align-items-center vh-100">
            ...
            <h3 class="mb-4"><span class="material-symbols-outlined mx-2" id="cust_icon">group</span>Show Customer</h3>
			  ...
			  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
			    <div class="modal-content">
			      <div class="modal-header">
				  	<h1 class="modal-title fs-5" id="modalLabel"><span class="material-symbols-outlined me-2">group</span>Customer Edit:</h1>
